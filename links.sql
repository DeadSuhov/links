...
CREATE TABLE `UserLinks` (
  ...
  KEY `link` (`link`),
  KEY `user` (`user`),
  CONSTRAINT `UserLinks_ibfk_1` FOREIGN KEY (`link`) REFERENCES `Links` (`id`) ON DELETE CASCADE,
  CONSTRAINT `UserLinks_ibfk_2` FOREIGN KEY (`user`) REFERENCES `Users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
